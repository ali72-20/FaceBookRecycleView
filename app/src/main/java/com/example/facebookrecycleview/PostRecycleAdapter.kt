...
class PostRecycleAdapter(val items:List<Posts>) : RecyclerView.Adapter<PostRecycleAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView:View) : RecyclerView.ViewHolder(itemView){
        ...
        val like : TextView = itemView.findViewById(R.id.likesNumbers)
        val comment:TextView = itemView.findViewById(R.id.tv_Comment)
        val share :TextView= itemView.findViewById(R.id.tv_share_numbres)
        val likes :TextView= itemView.findViewById(R.id.tv_Like)
        val shares : TextView = itemView.findViewById(R.id.Share)
